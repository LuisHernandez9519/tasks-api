...
export class TasksController {
  ...
  async getTask(@Param('id', ParseIntPipe) id: number) {
    try {
      ...
      const responseSingleDto = plainToClass(
        ResponseSingleDto<Task>,
        responseObject,
      );
  ...
  async getTasks(@Query() data: QueryParamDto) {
    try {
      ...
      const responsePaginationDto = plainToInstance(
        ResponsePaginationDto<Task>,
        responseObject,
      );
  ...
  async createTask(@Body() data: CreateTaskDto) {
    try {
      ...
      const responseSingleDto = plainToInstance(
        ResponseSingleDto<Task>,
        responseObject,
      );
